...
test_matrix_x BYTE 1, 1, 1, 0, 0, 0, 1, 0, 2, 1, 3, 0, 0, 4, 5, 0, 47 DUP(0), 2
...
INVOKE draw_matrix, OFFSET interface_layout_upperleft, 2813h, 0000h, LIGHTGRAY + RED*16
INVOKE draw_matrix, OFFSET interface_layout_lowerleft, 2806h, 1300h, LIGHTGRAY + RED*16
INVOKE draw_matrix, OFFSET interface_layout_right, 2819h, 0028h, LIGHTGRAY + RED*16

mov eax, OFFSET test_matrix_x
call draw_map
